...
import React from 'react';
import { Container, Row, Col } from 'react-bootstrap';
import styles from '../stylesheets/Ourworld.module.css';
import 'bootstrap/dist/css/bootstrap.min.css';
import Grazing from '../assets/Grazing-Horse-2.webp';
import forestwalk from '../assets/Forest walk.mov';
import pannaga from '../assets/pannaga.webp';
...
const OurWorld = () => {
  return (
    <>
      <Container fluid className="p-0">
        <Row className="m-0 pt-lg-5">
          <Col
            className={`d-flex align-items-center justify-content-center text-light py-5 ${styles.heroSection}`}
          >
      ...
      <Container fluid className={styles.worldContainer}>
        {/* Row 1 */}
        <Row className={`align-items-center ${styles.rowPad}`}>
          <Col md={4} className={`text-center mb-4 mb-md-0 ${styles.mediaCol}`}>
            <img
              src={Grazing}
              alt="Horse in Morning Sun"
          ...
          <Col md={4} className={styles.mediaCol}>
            <video
              autoPlay
              muted
              loop
        ...
        {/* Row 2 */}
        <Row className={`align-items-center mt-4 ${styles.rowPad}`}>
          <Col md={4} className="text-center mb-4 mb-md-0">
            <p className={styles.poemText}>
              Fresh dew and <br />
              post ride gossip session! <br />
              <span className={styles.poemTextLarge}>
                (horses are the best secret keepers)
              </span>
            </p>
          </Col>
        ...
        {/* Row 4: Full Width Single Image */}
        <Row className={`mt-4 ${styles.rowPad}`}>
          <Col>
            <img
              src={finalImage}
              alt="Final Showcase"
        ...
        {/* Poem Section */}
        <Row className={`justify-content-center mt-5 ${styles.rowPad}`}>
          <Col md={8} className="text-center">
            <h4 className={styles.poemTitle}>Slippery Wood</h4>
            <p className={styles.poemBody}>
              The early morning air,{"\n"}
              The dews on leather{"\n"}
              The saddle all slippery,{"\n"}
              The stirrups slipping like feathers.{"\n"}
        ...
        {/* 3 Images Row */}
        <Row className={`mt-5 ${styles.rowPad}`}>
          <Col md={4} className="text-center mb-4 mb-md-0">
            <img
              src={imageLeft}
              alt="Left"
        ...
        {/* Row with poem and images */}
        <Row className={`align-items-center mt-4 ${styles.rowPad}`}>
          <Col md={4} className="text-center mb-4 mb-md-0">
            <img
              src={world1}
              alt="Horse in Morning Sun"
              className={styles.mediaImgTall}
            />
          </Col>
          <Col md={4} className="text-center">
            <p className={styles.poemText}>
        ...
        <Row className={`justify-content-center mt-5 ${styles.rowPad}`}>
          <Col md={8} className="text-center">
            <h4 className={styles.poemTitle}>Bold Rhythm</h4>
            <p className={styles.poemBody}>
              Bold decisions,{"\n"}
              Gradient smiles,{"\n"}
              The feeling of control at its prime.{"\n"}
