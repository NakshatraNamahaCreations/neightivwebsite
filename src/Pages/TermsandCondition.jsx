        ...
        <Container>
          <Row className="justify-content-center">
            <Col md={10}>
              ...
              <p style={{ color: '#000', fontSize: '16px', marginBottom: '20px' }}>
                This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <a href="https://neightivglobal.com" style={{ color: '#000', textDecoration: 'underline' }}>neightivglobal.com</a> (“Website”), including the related mobile site and mobile application (hereinafter referred to as “Platform”).
              </p>
              <p style={{ color: '#000', fontSize: '16px', marginBottom: '20px' }}>
                The Platform is owned by Neightiv India Private Limited, a company incorporated under the Companies Act, 2013 with its registered office at No 612, Suguna Upper Crest Apartment, Bangarappa Nagar main road, Gattigere, RR Nagar, Bangalore - 560098 (hereinafter referred to as "Platform Owner", "we", "us", "our").
              </p>
              <p style={{ color: '#000', fontSize: '16px', marginBottom: '20px' }}>
              ...
              <p style={{ color: '#000', fontSize: '16px', marginBottom: '20px' }}>
                All the Policies and terms mentioned in this website including Cancellation Policy, Shipping Policy, Exchange Policy and Privacy Policy are applicable to all the users.
              </p>
              <p style={{ color: '#000', fontSize: '16px', marginBottom: '20px' }}>
              ...
              <p style={{ color: '#000', fontSize: '16px', marginBottom: '20px', fontWeight: '500' }}>
              ...
              <ul style={{ color: '#000', fontSize: '16px', paddingLeft: '20px', marginBottom: '20px' }}>
                ...
                <li style={{ marginBottom: '10px' }}>
                  You agree and acknowledge that website and the Services may contain links to other third party websites. On accessing these links, you will be governed by the terms of use, privacy policy and such other policies of such third party websites. The Losses and damages caused by Third party websites and services shall not be binding on the Platform Owners. These links are provided for your convenience to provide further information.
                </li>
                <li style={{ marginBottom: '10px' }}>
              ...
              <p style={{ color: '#000', fontSize: '16px', marginBottom: '10px' }}>
                If you have any queries about these Terms and Conditions or need assistance, feel free to reach out to our support team:
              </p>
              <p style={{ color: '#000', fontSize: '16px', marginBottom: '10px' }}>
