...
import React from 'react';
import { Container, Row, Col } from 'react-bootstrap';
import styles from "../stylesheets/Customprints.module.css"
import 'bootstrap/dist/css/bootstrap.min.css';
import Scarves from '../assets/Scarves.webp';
import Custom_print_process from '../assets/Custom_print_process.webp';
import Isabelle1 from '../assets/Isabelle1.webp';
...
const CustomPrints = () => {
  return (
    <div className={styles.customPrintsRoot}>
      <Container fluid className="p-0">
        <Row className="m-0">
          {/* Left Column: Background Color and Text */}
          <Col
          ...
          >
            <div>
              <h1 className={styles.heading}>Get customised silk scarves!</h1>
      ...
      <Container fluid className={`py-5 ${styles.examplesSection}`}>
        <h2 className={styles.examplesHeading}>
          Examples of Custom Scarves
        </h2>
        <Row className={`justify-content-center ${styles.exampleRow}`}>
          {/* Left Column: Two Images */}
          <Col md={6} className={styles.exampleCol}>
          ...
          {/* Right Column: Text Content */}
          <Col md={6} className={`d-flex align-items-center ${styles.textCol}`}>
        ...
        <br />
        <Row className={`justify-content-center mt-2 ${styles.exampleRow}`}>
          <Col md={6} className={styles.exampleCol}>
            <div className={styles.imgPair}>
              <div className={styles.imgBox}>
                <img
        ...
        <div className={`mt-4 text-center ${styles.contactSection}`}>
          <p className={styles.contactText}>
            Email us for further details at{" "}
            <a href="mailto:contact@neightivglobal.com" className={styles.contactLink}>
              contact@neightivglobal.com
            </a>
          </p>
        </div>
